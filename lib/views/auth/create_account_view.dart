          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                CircleAvatar(
                  radius: 60,
                  backgroundImage: (_imageFile == null ? const AssetImage('assets/3.jpg') : FileImage(_imageFile!)) as ImageProvider
                    ...
                    showModalBottomSheet(context: context, builder: (context){
                      return SizedBox(
                        ...
                        child: Column(children: [
                          TextButton.icon(onPressed: ()=>selectImage(imageSource: ImageSource.camera), icon: const Icon(UniconsLine.camera,), label: const Text('Select from Camera',),),

                          TextButton.icon(
                                  onPressed: () =>selectImage(imageSource: ImageSource.gallery),
                                  icon: const Icon(
                                    UniconsLine.picture,
                                  ),
                                  label: const Text(
